...
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,Damage:1}}},scores={wrench_use=1..}] at @s positioned ~ ~1.67 ~ run function terracotta_wrench:use
