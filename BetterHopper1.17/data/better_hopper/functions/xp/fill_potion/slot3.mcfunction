...
execute if score TEMP bh_hopper_xp matches 1408.. run item replace block ~ ~-1 ~ container.3 with minecraft:potion{xppoints:1408s,bhXpBottle:1b,full:1b,CustomPotionColor:9436928,HideFlags:63,display:{Lore:['[{"text":"§2XP: 1408/1408"}]'],Name: "{\"text\":\"§eExperienceb Bottle\"}"},Enchantments:[{lvl:1,id:"minecraft:unbreaking"}]}
